<x-app-layout>
    <x-slot name="header">
        {{ __('Create Identitas Persalinan') }}
    </x-slot>
    <form method="POST" action="{{ route('identitas-persalinan.store',['author' => auth()->user()->id]) }}"
        ...
        <x-card class="card-primary">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input id="nama_ibu" class="{{ $errors->has('nama_ibu') ? ' is-invalid' : '' }}" type="text"
                        name="nama_ibu" value="{{ old('nama_ibu') }}" tabindex="1" required autofocus />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <x-input id="umur" class="{{ $errors->has('umur') ? ' is-invalid' : '' }}" type="number"
                            name="umur" value="{{ old('umur') }}" tabindex="1" required min="0" step="1" />
            ...
            <div class="form-group">
                ...
                <x-input id="nama_suami" class="{{ $errors->has('nama_suami') ? ' is-invalid' : '' }}" type="text"
                    name="nama_suami" value="{{ old('nama_suami') }}" tabindex="1" required />
                <x-input-error for="nama_suami" />
            </div>
            <div class="form-group">
                <x-label for="alamat">{{ __('Alamat') }}</x-label>
                <x-textarea name="alamat" id="alamat">{!! old('alamat') !!}</x-textarea>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input type="date" name="tgl_partus" class="{{ $errors->has('tgl_partus') ? ' is-invalid' : '' }}"
                        required value="{{ old('tgl_partus') }}" min="{{ date('Y-m-d') }}" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input id="kondisi_ibu" class="{{ $errors->has('kondisi_ibu') ? ' is-invalid' : '' }}" type="text"
                        name="kondisi_ibu" value="{{ old('kondisi_ibu') }}" tabindex="1" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <x-input type="text" name="jml_darah"
                            ...
                            value="{{ old('jml_darah') }}" min="{{ date('Y-m-d') }}" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="partograf" id="partograf"
                            ...
                            <option value="1" {{ old('partograf') == '1' ? 'selected' : '' }}>{{ __('Ada') }}</option>
                            <option value="0" {{ old('partograf') == '0' ? 'selected' : '' }}>{{ __('Tidak') }}</option>
                        </select>
        ...
        <x-card class="card-primary">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="jk_bayi" id="jk_bayi"
                            ...
                            <option value="1" {{ old('jk_bayi') == '1' ? 'selected' : '' }}>{{ __('Laki-Laki') }}
                            </option>
                            <option value="0" {{ old('jk_bayi') == '0' ? 'selected' : '' }}>{{ __('Perempuan') }}
                            </option>
                        </select>
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input id="bbl" class="{{ $errors->has('bbl') ? ' is-invalid' : '' }}" type="number" min="0"
                        step="1" name="bbl" value="{{ old('bbl') }}" tabindex="1" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="imd" id="imd" class="form-control {{ $errors->has('imd') ? ' is-invalid' : '' }}">
                            <option value="1" {{ old('imd') == '1' ? 'selected' : '' }}>{{ __('Ya') }}</option>
                            <option value="0" {{ old('imd') == '0' ? 'selected' : '' }}>{{ __('Tidak') }}</option>
                        </select>
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input id="tgl_unijek" class="{{ $errors->has('tgl_unijek') ? ' is-invalid' : '' }}" type="date"
                        min="{{ date('Y-m-d') }}" name="tgl_unijek" value="{{ old('tgl_unijek') }}" tabindex="1" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <x-input id="tgl_vit_k" class="{{ $errors->has('tgl_vit_k') ? ' is-invalid' : '' }}" type="date"
                        min="{{ date('Y-m-d') }}" name="tgl_vit_k" value="{{ old('tgl_vit_k') }}" tabindex="1" />
                ...
                <div class="col-md-6 col-lg-6 col-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="jns_persalinan" id="jns_persalinan"
                            ...
                            <option value="n" {{ old('jns_persalinan') == 'n' ? 'selected' : '' }}>{{ __('Normal') }}
                            </option>
                            <option value="sp" {{ old('jns_persalinan') == 'sp' ? 'selected' : '' }}>{{ __('Spontan') }}
                            </option>
                            <option value="sc" {{ old('jns_persalinan') == 'sc' ? 'selected' : '' }}>
                                {{ __('Operasi sesar') }}
                            </option>
                            <option value="in" {{ old('jns_persalinan') == 'in' ? 'selected' : '' }}>
                                {{ __('Induksi') }}
                            </option>
                            <option value="ve" {{ old('jns_persalinan') == 've' ? 'selected' : '' }}>
                                {{ __('Vakum') }}
                            </option>
                        </select>
            ...
            <div class="form-group">
                ...
                <x-input type="text" name="status_bayar" class="{{ $errors->has('status_bayar') ? ' is-invalid' : '' }}"
                    required value="{{ old('status_bayar') }}" />
